          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                <CharReveal stagger={0.015}>Privacy Policy</CharReveal>
              </h1>
              ...
              <p className="font-body text-lg md:text-xl text-[hsl(var(--muted-foreground))] max-w-3xl leading-relaxed mb-4">
                ...
                Luminary Lab collects, uses, and protects your personal
                information.
              </p>
        ...
        <section className="w-full py-16 md:py-24">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              {/* Data Security */}
              <SectionCard title="Data Security" icon={Lock} index={2}>
                <p className="mb-4">
                ...
                <div className="space-y-4">
                  <div className="bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] p-4 rounded-sm">
                    ...
                    <p className="font-body text-sm text-[hsl(var(--muted-foreground))]">
                      All payment processing is handled by Stripe. We do not
                  ...
                  <div className="bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] p-4 rounded-sm">
                    ...
                    <p className="font-body text-sm text-[hsl(var(--muted-foreground))]">
                      Images are stored on Amazon Web Services S3 with
                  ...
                  <div className="bg-[hsl(var(--secondary))] border border-[hsl(var(--border))] p-4 rounded-sm">
                    ...
                    <p className="font-body text-sm text-[hsl(var(--muted-foreground))]">
                      User data is stored in Neon PostgreSQL database with
              ...
              {/* Your Rights */}
              <SectionCard title="Your Rights" icon={CheckCircle} index={4}>
              ...
              >
                ...
                >
                  ...
                  <p className="font-body text-[hsl(var(--muted-foreground))] mb-6 max-w-xl mx-auto">
                    ...
                    we handle your data, please contact our privacy team.
                  </p>
                  <a
