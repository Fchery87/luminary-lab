...
const MOCK_PRESETS: Preset[] = [
  {
    ...
    exampleImageUrl:
      "https://images.unsplash.com/photo-1542038784456-1ea8e935640e?q=80&w=600&auto=format&fit=crop", // Placeholder
  },
  {
    id: "p2",
  ...
  },
  {
    ...
    exampleImageUrl:
      "https://images.unsplash.com/photo-1517502166878-35c93c008235?q=80&w=600&auto=format&fit=crop",
  },
];
...
export default function CoreUITestPage() {
  ...
  const afterImage =
    "https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=2000&auto=format&fit=crop"; // Different look for contrast
    ...
    <div className="min-h-screen bg-background text-foreground p-8 space-y-12 max-w-7xl mx-auto">
      <div className="space-y-2">
        ...
        <p className="text-muted-foreground">
          Testing new components for Task 008, 011, 012
        </p>
      </div>
          ...
          <section className="space-y-4">
            ...
            <div className="p-6 bg-card rounded-md border border-border flex flex-col items-center justify-center gap-4">
              <p className="text-sm text-muted-foreground text-center">
                Ready to save your masterpiece?
              </p>
          ...
          <section className="space-y-4 h-full">
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              ...
              <div className="p-4 rounded-sm border border-border bg-card/50">
                ...
                <p className="text-xs text-muted-foreground">
                  Filter:{" "}
                  {MOCK_PRESETS.find((p) => p.id === selectedPreset)?.name ||
                    "None"}
                </p>
                <p className="text-xs text-muted-foreground">
                  Intensity: {intensity}%
