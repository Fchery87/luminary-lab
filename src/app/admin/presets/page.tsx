...
export default function AdminPresetsPage() {
  ...
  const { data: response, isLoading } = useQuery({
    queryKey: [
      "admin-presets",
      { search: searchQuery, includeInactive: showInactive },
    ],
    queryFn: async () => {
  ...
  const sortedPresets = [...filteredPresets].sort(
  ...
  const resetForm = () => {
    setFormData({
      ...
      isActive: true,
      sortOrder:
        Math.max(...presets.map((p: SystemStyle) => p.sortOrder), 0) + 1,
      blendingParams: {},
    });
  };
              ...
              >
                <div>
                  <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
                    ...
                    <TextShimmer shimmerColor="#30e3ca">
                      Preset Management
                    </TextShimmer>
                  </h1>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingPreset
                ? "Modify the existing preset settings."
                : "Configure a new AI processing preset."}
            </DialogDescription>
          </DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    exampleImageUrl: e.target.value,
                  }))
                }
            ...
            <div className="flex gap-2 pt-4">
              ...
              <Button
                ...
                className="flex-1"
              >
                {upsertPresetMutation.isPending
                  ? "Saving..."
                  : editingPreset
                    ? "Update Preset"
                    : "Create Preset"}
