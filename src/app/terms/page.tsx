          ...
          <div className="container mx-auto px-6">
            ...
            >
              ...
              <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                <CharReveal stagger={0.015}>Terms of Service</CharReveal>
              </h1>

              <p className="font-body text-lg md:text-xl text-[hsl(var(--muted-foreground))] max-w-3xl leading-relaxed mb-4">
                By using Luminary Lab, you agree to these terms. Please read
                them carefully.
              </p>
        ...
        <section className="w-full py-16 md:py-24">
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              >
                <p className="mb-4">
                  By accessing or using Luminary Lab, you agree to be bound by
              ...
              {/* Usage Rules */}
              <SectionCard title="Usage Rules" icon={AlertTriangle} index={2}>
                <p className="mb-4">
              ...
              >
                <div className="space-y-4">
                  <div>
                    <h4 className="font-display font-semibold text-sm mb-2 text-[hsl(var(--foreground))]">
                      YOUR CONTENT
                    </h4>
                    <p className="text-[hsl(var(--muted-foreground))]">
                      You retain ownership of all images and content you upload.
                      Luminary Lab does not claim any rights to your original
                      photographs.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-[hsl(var(--muted-foreground))]">
                      Enhanced images are owned by you. We provide a license to
                      use our AI processing technology.
                    </p>
                  </div>
                  <div>
                    <h4 className="font-display font-semibold text-sm mb-2 text-[hsl(var(--foreground))]">
                    ...
                    <p className="text-[hsl(var(--muted-foreground))]">
                      All trademarks, logos, and service marks displayed on
                      Luminary Lab are our property or licensed to us.
                    </p>
                  </div>
                </div>
              </SectionCard>
              ...
              >
                <p className="mb-4">
                  To the fullest extent permitted by law, Luminary Lab shall not
                  be liable for:
                </p>
                <ul className="space-y-2 ml-6">
                  {[
              ...
              {/* Termination */}
              <SectionCard title="Termination" icon={Scale} index={6}>
                <p className="mb-4">
              ...
              <Frame
                accent
                className="bg-[hsl(var(--card))] p-8 md:p-12 text-center max-w-4xl mx-auto"
              >
                <motion.div
                ...
                >
                  ...
                  <p className="font-body text-[hsl(var(--muted-foreground))] mb-6 max-w-xl mx-auto">
                    ...
                    our services, please contact our legal team.
                  </p>
                  <a
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 max-w-7xl mx-auto">
            ...
            <div className="flex gap-8">
              <a
                href="/privacy"
                className="font-body text-sm text-[hsl(var(--foreground))] hover:text-[hsl(var(--gold))] transition-colors"
              >
                Privacy
              </a>
              <a
                href="/terms"
                className="font-body text-sm text-[hsl(var(--gold))]"
              >
                Terms
              </a>
            </div>
