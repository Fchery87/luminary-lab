...
export default function RegisterPage() {
  ...
  const validateForm = (): boolean => {
    ...
    const emailError =
      FormValidator.required(formData.email, "Email") ||
      FormValidator.email(formData.email, "Email");
    const passwordError =
      FormValidator.required(formData.password, "Password") ||
    ...
    if (formData.confirmPassword) {
      ...
      confirmPasswordError = FormValidator.required(
      ...
      <div className="flex min-h-screen items-center justify-center bg-[hsl(var(--background))] text-[hsl(var(--foreground))] relative selection:bg-[hsl(var(--gold))]/20 overflow-hidden">
        ...
        >
          ...
          <div className="space-y-4 pt-2">
            ...
            >
              {isLoadingSocial === "github" ? (
                ...
                <svg
                  className="mr-2 h-4 w-4 fill-[hsl(var(--foreground))]"
                  role="img"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <p className="text-center text-sm text-[hsl(var(--muted-foreground))] font-body pt-4">
            ...
            <Link
              href="/login"
              className="underline hover:text-[hsl(var(--gold))] transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-[hsl(var(--gold))] focus:ring-offset-2 rounded-sm"
            >
              Sign in
            </Link>
          </p>
