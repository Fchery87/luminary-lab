...
export default function RegisterPage() {
  ...
  const validateForm = (): boolean => {
    const nameError = FormValidator.required(formData.name, 'Name');
    ...
    if (formData.confirmPassword) {
      ...
      confirmPasswordError = FormValidator.required(formData.confirmPassword, 'Confirm Password');
    }
        ...
        >
          ...
          <div className="text-center space-y-2">
            ...
            <p className="font-body text-[hsl(var(--muted-foreground))] text-sm">
              Join Luminary Lab for AI-powered editing
            </p>
          </div>
          ...
          <div className="space-y-4 pt-2">
            ...
            >
              ...
              {isLoadingSocial === 'google' ? 'Connecting...' : 'Sign up with Google'}
            </Button>
            <Button
              variant="outline"
              className="w-full h-11 bg-[hsl(var(--secondary))] hover:bg-[hsl(var(--card))] border-[hsl(var(--border))]/50 transition-all hover:border-[hsl(var(--gold))]/40 rounded-sm font-body"
            ...
            >
              ...
              {isLoadingSocial === 'github' ? 'Connecting...' : 'Sign up with GitHub'}
            </Button>
          </div>
          ...
          <p className="text-center text-sm text-[hsl(var(--muted-foreground))] font-body pt-4">
            ...
            <Link href="/login" className="underline hover:text-[hsl(var(--gold))] transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-[hsl(var(--gold))] focus:ring-offset-2 rounded-sm">
              Sign in
            </Link>
          </p>
        </motion.div>
