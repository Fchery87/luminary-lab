 ...
 */
export async function decodeBlurHashToDataUrl(blurHash: string, width = 32, height = 32): Promise<string> {
 ...
 */
export function decodeBlurHashToPixels(blurHash: string, width: number, height: number): Uint8ClampedArray {
