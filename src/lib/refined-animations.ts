...
export const cardStyles = {
  ...
  hover:
    "hover:border-white/10 hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.08)]",
...
export const emptyStateStyles = {
  ...
  iconBox:
    "w-20 h-20 rounded-2xl bg-gradient-to-br from-secondary/50 to-secondary/20 flex items-center justify-center mb-6",
...
export function getGlassCardStyles(hover = false) {
  ...
  const hoverClass = hover
    ? "hover:border-white/10 hover:shadow-[0_8px_30px_-4px_rgba(0,0,0,0.06)]"
    : "";
...
export function getElegantHoverStyles() {
  return {
    className:
      "group-hover:translate-y-[-2px] group-hover:shadow-[0_8px_24px_-2px_rgba(0,0,0,0.08)] transition-all duration-300",
  };
}
...
export const textAlternatives = {
  ...
  subtle:
    "text-4xl font-bold tracking-tight opacity-90 transition-opacity duration-500 hover:opacity-100",
};
